...
public class BizController {
    ...
    public RpcServiceResult hello() {
        ...
        if (StringUtils.isEmpty(hello)) {
            return RpcServiceResult.getFailureResult("-1", "failed");
        }
    ...
    public RpcServiceResult queryUserList(@RequestBody FlowEntity flowEntity) {
        String uuid = bizManager.selectUuid(flowEntity.getUuid());
